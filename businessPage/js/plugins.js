...
$('<div class="quantity-nav"><div class="quantity-button quantity-up">+</div><div class="quantity-button quantity-down">-</div></div>').insertAfter(".quantity input"), $(".quantity").each(function() { var t = jQuery(this),
        i = t.find('input[type="number"]'),
        n = t.find(".quantity-up"),
        a = t.find(".quantity-down"),
        u = i.attr("min"),
        r = i.attr("max");
    n.click(function() { var n = parseFloat(i.val()); if (n >= r) var a = n;
        else a = n + 1;
        t.find("input").val(a), t.find("input").trigger("change") }), a.click(function() { var n = parseFloat(i.val()); if (n <= u) var a = n;
        else a = n - 1;
...
! function(t, n) { "object" == typeof exports && "object" == typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define("item-quantity-dropdown", [], n) : "object" == typeof exports ? exports["item-quantity-dropdown"] = n() : t["item-quantity-dropdown"] = n() }(this, function() { return function(t) {
        function n(o) { if (e[o]) return e[o].exports; var r = e[o] = { exports: {}, id: o, loaded: !1 }; return t[o].call(r.exports, r, r.exports, n), r.loaded = !0, r.exports } var e = {}; return n.m = t, n.c = e, n.p = "", n(0) }([function(t, n, e) { "use strict";
        e(1),
            function(t) { var n = { maxItems: 1 / 0, minItems: 0, selectionText: "item", textPlural: "items", controls: { position: "right", incrementText: "+", decrementText: "-", displayCls: "iqdropdown-item-display", controlsCls: "iqdropdown-item-controls", counterCls: "counter" }, items: {}, onChange: function() {}, beforeDecrement: function() { return !0 }, beforeIncrement: function() { return !0 } };
                t.fn.iqDropdown = function(e) {
                    function o(t, n) { var e = parseInt(n.data("mincount"), 10),
                            o = parseInt(n.data("maxcount"), 10);
                        u.items[t] = { minCount: isNaN(e) ? 0 : e, maxCount: isNaN(o) ? 1 / 0 : o } }

                    function r(n, e, o) { var r = t("<div />").addClass(u.controls.controlsCls),
                            i = t("<button>" + u.controls.decrementText + "</button>"),
                            s = t("<button>" + u.controls.incrementText + "</button>"),
                            a = t("<span>" + l[n] + "</span>").addClass(u.controls.counterCls); return e.children("div").addClass(u.controls.displayCls), r.append(i, a, s), "right" === u.controls.position ? e.append(r) : e.prepend(r), i.click(function(t) { var e = u.items,
                                r = u.minItems,
                                i = u.beforeDecrement,
                                s = u.onChange,
                                c = i(n, l);
                            c && d > r && l[n] > e[n].minCount && (l[n]--, d--, a.html(l[n]), o(), s(n, l[n], d)), t.preventDefault() }), s.click(function(t) { var e = u.items,
                                r = u.maxItems,
                                i = u.beforeIncrement,
                                s = u.onChange,
                                c = i(n, l);
                            c && d < r && l[n] < e[n].maxCount && (l[n]++, d++, a.html(l[n]), o(), s(n, l[n], d)), t.preventDefault() }), e.click(function(t) { return t.stopPropagation() }), e }

                    function i() { var t = 1 !== d && u.textPlural.length > 0,
                            n = t ? u.textPlural : u.selectionText;
                        s.html(d + " " + n) } var s = this.find("p").last(),
                        a = this.find("ul"),
                        c = a.find("li"),
                        u = t.extend(!0, {}, n, e),
                        l = {},
                        d = 0; return this.click(function() { s.toggleClass("menu-open"), a.toggleClass("show-menu") }), c.each(function() { var n = t(this),
                            e = n.data("id"),
                            s = parseInt(n.data("defaultcount") || "0", 10);
                        l[e] = s, d += s, o(e, n), r(e, n, i) }), i(), this } }(jQuery) }, function(t, n) {}]) });
...
// Weather=============================================
jQuery, $.fn.ideaboxWeather = function(a) { return a = $.extend({ modulid: "ideaboxWeather", width: "100%", themecolor: "#069", todaytext: "Today", radius: !0, location: "Newyork", daycount: 7, imgpath: "images/wimg/", template: "vertical", lang: "en", metric: "C", days: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], dayssmall: ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"] }, a), this.each(function() {
        function t() { $(a.modulid).width() < 200 ? $(a.modulid).addClass("ow-small") : $(a.modulid).removeClass("ow-small") }

        function d(a) { return a.substring(0, 1).toUpperCase() + a.substring(1).toLowerCase() }
        a.modulid = "#" + $(this).attr("id"), $(a.modulid).css({ width: a.width, background: a.themecolor }), a.radius && $(a.modulid).addClass("ow-border"), $.get("http://api.openweathermap.org/data/2.5/forecast/daily?q=" + a.location + "&mode=xml&units=metric&cnt=" + a.daycount + "&lang=" + a.lang + "&appid=0ac06341513ff205b3e3f3b6188588e3", function(t) { var i = $(t),
                e = "",
                n = i.find("name").text();
            i.find("time").each(function(t, i) { var s = $(this),
